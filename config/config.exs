...
config :calculator_api, :phoenix_swagger,
  swagger_files: %{
    "priv/static/swagger.json" => [
      router: CalculatorApiWeb.Router,     # phoenix routes will be converted to swagger paths
      endpoint: CalculatorApiWeb.Endpoint  # (optional) endpoint config used to set host, port and https schemes.
    ]
  }
